...
class ChatPage(ttk.Frame):
    ...
    It inherits from the tkinter.ttk.Frame class and provides a layout for chat messages, online users,
    and message input area along with related functionality.

    Attributes:
        parent (tk.Tk): Reference to the parent ChatView object.
    """
    def __init__(self, parent, container):
        """
        Initializes the ChatPage frame with its parent and container, and sets up the layout, widgets, and event bindings.

        Args:
            parent (tk.Tk): Reference to the parent ChatView object.
            container (tk.Frame): The parent widget in which the ChatPage frame is placed.
        """
